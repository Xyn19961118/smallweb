            ...
            <ul>
              ...
              <li>
                ...
                <div class="goods">
                  ...
                  <div class="goods-content">
                    <div class="goods-item" v-for="(item, index) in form.goodsList" :key="index">
                      <el-row>
                        <el-col :span="4">
                          <el-form-item
                        ...
                        <el-col :span="3">
                          <div class="submit-info submit-info-last">
                            <el-form-item :prop="'goodsList.' + index + '.enquiry_image'">
                              <el-upload
              ...
              <li class="other-info">
                ...
                <el-form-item label="交货地">
                  <el-cascader v-model="form.delivery_area_id" :props="address" />
                </el-form-item>
                  ...
                  <div class="require-info">
                    ...
                    <div class="require-info-item">
                      ...
                      <div class="fapiao">
                        ...
                        <el-cascader v-model="form.supply_area_id" :props="address" />
                      </div>
                    </div>
                    <div class="require-info-item">
                      <label>经营模式</label>
...
import { release, addressCity } from "@/api/dynamic";
...
export default {
  ...
  methods: {
    ...
    // 文件状态改变
    handleChange (index) {
      this.form.goodsList[index.index].hideUpload = true;
    ...
    handleUpload (index, res, file) {
      this.form.goodsList[index.index].enquiry_image = res.data;
      this.form.goodsList[index.index].hideUpload = true;
    },

    //移出上传图片
    handleDelete (index) {
      this.form.goodsList[index.index].hideUpload = false;
      this.form.goodsList[index.index].enquiry_image = "";
    },
    ...
    //提交
    handleSubmit () {
      const { isShowLogin, business } = this
      if (!isShowLogin) {
        this.changeLoginMask()
        return false
      }
      if (business == '1') {
        this.$message.warning('卖家不能发布需求')
        return false
      }
      this.$refs["ruleForm"].validate(async valid => {
        if (valid) {
          ...
          subData.goodsList.forEach(item => {
            delete item.hideUpload;
          });
          let modue = await release(subData);
