          ...
          <div class="main-left">
            ...
            >
              ...
              <el-table-column label="采购量" width="100">
                <template slot-scope="scope">
                  <p>
                    <span>{{ scope.row.quantity }}</span>件
                  </p>
                </template>
              </el-table-column>
              <el-table-column label="报价截至日期" width="150">
                <template slot-scope="scope">
                  ...
                  <p v-if="scope.row.remaining_day">
                    剩余
                    <span>{{ scope.row.remaining_day }}</span>天
                  </p>
              ...
              <el-table-column v-if="showBtn" label width="120">
                <template v-if="showBtn" slot-scope="scope">
                  <el-button
                    size="small"
                    type="danger"
...
export default {
  ...
  created () {
    ...
    const keywo = this.$route.query.search
    if (keywo) {
      this.keyword = keywo
    }
    this.getDynamicList()
